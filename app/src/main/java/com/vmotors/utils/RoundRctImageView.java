...
public class RoundRctImageView extends AppCompatImageView {
    ...
    private static final int DEFAULT_CIRCLE_BACKGROUND_COLOR = Color.YELLOW;
    ...
    private float mDrawableRadius =30.0f;
    private float mBorderRadius = 30.0f;
    ...
    public RoundRctImageView(Context context) {
        super(context);

        init();
    }

    public RoundRctImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RoundRctImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mBorderRadius = a.getDimensionPixelSize(R.styleable.CircleImageView_civ_cornor_radius, DEFAULT_RADIUS);
        mDrawableRadius = a.getDimensionPixelSize(R.styleable.CircleImageView_civ_cornor_radius, DEFAULT_RADIUS);
...
//        mDrawableRadius = Math.min(mDrawableRect.height() / 2.0f, mDrawableRect.width() / 2.0f);
    ...
    private class OutlineProvider extends ViewOutlineProvider {
        ...
        public void getOutline(View view, Outline outline) {
            ...
            outline.setRoundRect(bounds, mDrawableRadius);
        }
